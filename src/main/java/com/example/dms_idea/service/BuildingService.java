...
public interface BuildingService {
    PageBean<Building> getBuildingList(int pageNum, int pageSize, String prop,
                                       String order, String name, String unit_number,
                                       String dor_number, String stu_number, String manager_id);
